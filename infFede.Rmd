...
Adicionalmente, os interesa ver cómo se relaciona el nivel de ingresos con el máximo nivel de educación completo.
...
ggplot(datos, aes(x = occupation, fill = sex)) +
  ...
  theme_minimal() +  # Para un tema limpio
...
Por otro lado, los hombres son predominantes particularmente en trabajos de reparación, como pescadores o granjeros, en trabajos pesados o de limpieza, en servicios de seguridad, como choferes o como operarios/inspectores de máquinas.
