...
```
Finalmente, resulta importante analizar la distribución de sexo de acuerdo a los distintos tipos de ocupaciones. En particular, vemos que las mujeres dominan en trabajos de oficina o recepción (*Adm-clerical*) o como empleadas domésticas (*Priv-house-serv*). Por otro lado, los hombres son predominantes particularmente en trabajos de reparación, como pescadores o granjeros, en trabajos pesados o de limpieza, en servicios de seguridad, como choferes  o como operarios/inspectores de máquinas. Esto habla de la existencia de una brecha de género en el tipo de trabajo al que se puede acceder.
